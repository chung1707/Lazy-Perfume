      ...
      <ul>
        ...
        <li class="nav-item nav-item-has-children">
          ...
          <ul id="ddmenu_2" class="collapse dropdown-nav">
            <li>
              <a href="settings.html">Danh sách</a>
            </li>
            <li>
              <a href="blank-page.html">Nhập sản phẩm</a>
            </li>
          </ul>
        </li>
        <li class="nav-item nav-item-has-children">
          ...
          <ul id="ddmenu_3" class="collapse dropdown-nav">
            <li>
              <a href="signin.html">Chờ phê duyệt</a>
            </li>
            <li>
              <a href="signup.html">Đang xử lý</a>
            </li>
            <li>
              <a href="signup.html">Đã giao hàng</a>
            </li>
            <li>
              <a href="signup.html">Đã hủy</a>
            </li>
          </ul>
        </li>
