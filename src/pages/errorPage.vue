  ...
  <div>
    ...
    <section class="errorPage">
      ...
      <div class="errorPage__content">
        <div class="errorPage__message message">
          <h1 class="message__title">Page Not Found</h1>
          <p class="message__text">
            Xin lỗi, có vẻ trang mà bạn đang tìm kiếm không tồn tại. Nhấn vào nút bên dưới để trở về với chúng tôi
          </p>
        </div>
        <div class="errorPage__nav e-nav">
